...
$novanest_module_ui_blueprint_=[
  ...
  "page_layout"=>[
    ...
    "desired_column_order"=>[
        ...
        'fuel_inventory' => ['primkey','record_id', "item_name","item_code",'fuel_type', 'Selling_price','current_stock_litres','date_booked'],
    ...
    "date_columns"=>["created_on", "last_updated_on"],
    ...
    "rename_cols_array"=>['current_stock_litres'=>'Volume (Ltrs)',"percentage_variance"=>"Loss variance (%)"],
    ...
    "new_label_buttons_arr"=>['fuel_inventory'=>'plus-circle:Create inventory:Stock Item /{{item_code}} / {{item_name}}'],
    //sample 
