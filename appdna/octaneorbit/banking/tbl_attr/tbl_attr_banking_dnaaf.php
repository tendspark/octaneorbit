...
$custom_multi_grid_rows=[
    ...
    "deposit_list"=>[
         "table"=>"deposits_by_mode",
         "link"=>"transactions_list",
         "query"=>"deposit_file_id='{{record_id}}'",
         "title"=>"Deposits",
         "columns"=>["payment_mode","ref_number", "amount_deposited"],
          ],
...
//banking //"primkey" , "record_id" , "station_id" , "shift_code" , "record_date" , "expected_sales_amount" , "actual_banked_amount" , "variance_amount" , "variance_reason" , "banked_by" , "banked_on" , "bank_reference_code" , "banking_status" , "payment_notes" , "verified_by" , "verified_on" ,
...
$novanest_module_ui_blueprint_=[
  ...
  "page_layout"=>[
    ...
    "print_tables"=>["banking"],
    
    //==============================================   ///skip  these columns on the profile page 
    "skip_cols_profile"=>["banked_by" , "banked_on"  , "banking_status" , "verified_by" , "verified_on"],
        
    ///=============================================   skip  these columns on the list page 
    "skip_cols_list"=>["variance_reason" , "banked_by" , "banked_on" , "bank_reference_code" , "banking_status" , "payment_notes" , "verified_by" , "verified_on" ],
    ...
    "sum_cols_list"=>['amount_deposited_'],
    
    //============================================    on the profile page for these columns use textarea component
    "textarea_array"=>['payment_notes',"column_name2..."],
    ...
    "dynamic_drop_down_array"=>["fuel_type","fuel_grade"],
    ...
    "date_columns"=>["created_on", "record_date"],
    ...
    "rename_cols_array"=>['station_id'=>'Station',"expected_sales_amount"=>"Expected Amt","actual_banked_amount"=>"Amount banked"],
    ...
    ///"new_label_buttons_arr"=>['banking'=>'plus-circle:Add closing shift deposits :Banking deposit details '],
    "new_label_buttons_arr"=>['banking'=>'plus-circle: Record closing shift : Closing shift profile'],
