...
//fuel_sales //"primkey" , "record_id" , "fuel_station_id" , "pump_nozzle_id" , "vehicle_plate" , "fuel_type" , "quantity_sold_litres" , "sale_price_per_litre" , "total_amount" , "sold_by_staff_id" , "sale_method" , "sale_date" ,
...
$novanest_module_ui_blueprint_=[
  ...
  "page_layout"=>[
    ...
    "form_input_segmentation_arr"=>[
          //sample 
          "fuel_sales"=>[ 
                    "Sales info"=>["fuel_station_id" , "pump_nozzle_id" , "vehicle_plate" , "fuel_type" , "quantity_sold_litres" , "sale_price_per_litre" , "total_amount" , "sold_by_staff_id" , "sale_method" , "sale_date" ],
             ]
