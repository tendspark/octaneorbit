...
$novanest_module_ui_blueprint_=[
  ...
  "page_layout"=>[
    ...
    "date_columns"=>["created_on", "installed_on","last_maintenance_date"],
    ...
    "new_label_buttons_arr"=>['fuel_pump_nozzles'=>'plus-circle:Add Nozzle:Nozzle / {{nozzle_label}}'],
    //sample 
  ...
  "data_behaviour"=>[
    ...
    "connection_cols"=>['pump_id'=>'fuel_pumps:record_id:pump_name:/api/octaneorbit/pumps/fuelpumps'],
