...
//fuel_pump_nozzles //"primkey" , "record_id" , "pump_id" , "nozzle_label" , "fuel_type" , "calibration_factor" , "status" , "installed_on" , "last_maintenance_date" , "created_on" ,

//deposits_by_mode //"primkey" , "station_id" , "date_deposited" , "amount_deposited" , "payment_mode" , "shift_id" , "deposit_file_id" , "remark" ,
...
$novanest_module_ui_blueprint_=[
  ...
  "page_layout"=>[
    ...
    "dynamic_drop_down_array"=>["fuel_type","fuel_grade","payment_mode"],
    ...
    "date_columns"=>["created_on", "date_deposited","last_maintenance_date"],
    ...
    "rename_cols_array"=>['station_id'=>'Station',"percentage_variance"=>"Loss variance (%)"],
    ...
    "new_label_buttons_arr"=>['deposits_by_mode'=>'plus-circle: Record banking deposit : Deposit / {{ref_number}}'],
    //sample 
  ...
  "data_behaviour"=>[
    ...
    "connection_cols"=>[
      'deposit_file_id'=>'banking:record_id:record_id:/api/octaneorbit/banking/bankdeposits:handleInputChange(`txt_shift_id`,(dataRes?.shift_code))',
      'station_id'=>'fuel_stations:record_id:station_name:/api/octaneorbit/stations/fuelstations'
