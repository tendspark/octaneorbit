...
import DailysalesList from '../../sales/uiControl/DailysalesList';

import { InteprateDailysalesEvent } from '../../sales/dataControl/DailysalesRequestHandler';
    ...
    async function fetchData() {
     MosyNotify({message : "Loading chart data" , icon:"line-chart", addTimer:false})
      const response = await mosyGetData({
        endpoint: '/api/octaneorbit/dashboard/detection',
        params: {}
      });
